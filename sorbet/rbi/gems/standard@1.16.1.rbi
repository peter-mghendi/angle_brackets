...
class RuboCop::DirectiveComment
  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#30
  def initialize(comment, cop_registry = T.unsafe(nil)); end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#80
  def all_cops?; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#28
  def comment; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#85
  def cop_names; end
  ...
  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#91
  def department_names; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#105
  def directive_count; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#60
  def disabled?; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#75
  def disabled_all?; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#65
  def enabled?; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#70
  def enabled_all?; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#96
  def in_directive_department?(cop); end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#110
  def line_number; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#42
  def match?(cop_names); end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#55
  def match_captures; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#28
  def mode; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#101
  def overridden_by_department?(cop); end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#46
  def range; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#37
  def single_line?; end

  private

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#130
  def all_cop_names; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#134
  def cop_names_for_department(department); end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#126
  def department?(name); end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#140
  def exclude_redundant_directive_cop(cops); end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#120
  def parsed_cop_names; end

  # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#116
  def splitted_cops_string; end

  class << self
    # source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#24
    def before_comment(line); end
  end
end

# source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#17
RuboCop::DirectiveComment::COPS_PATTERN = T.let(T.unsafe(nil), String)

# source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#15
RuboCop::DirectiveComment::COP_NAMES_PATTERN = T.let(T.unsafe(nil), String)

# source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#13
...
# source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#11
RuboCop::DirectiveComment::REDUNDANT_DIRECTIVE_COP = T.let(T.unsafe(nil), String)

# source://rubocop/1.35.1/lib/rubocop/directive_comment.rb#9
